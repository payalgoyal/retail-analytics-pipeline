...
def customer_segmentation(engine):
...
def analysis():
    ...
    top_products = top_selling_analysis(df)
    ...
    top_countries = avg_order_by_country(df)
    ...
    norway_sales = norway_top_products(df)
    ...
    segment_counts = customer_segmentation(engine)
